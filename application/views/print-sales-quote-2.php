...
<table align="center" width="100%" height='100%' style="border:1px solid;">
        ...
        <th colspan="10">
          <table width="100%">
            <tr>
              ...
              <?=  $this->lang->line('sales_quotation');?>
              </th>
            </tr>
            <tr>
              <th colspan="6" style="">
            ...
            <tr class=" ">
              ...
              <td colspan="6" style="border: 1px solid;" >
                      <?= $this->lang->line('Quotation'); ?> : <?php echo "$sales_code"; ?><br>
  ...
  <tr style=''>
    ...
    <?php $colspan_1 = (!is_tax_disabled()) ? 4 : 5; ?>
...
<tbody style="border: 1px solid;">
 ...
 <?php
              ...
              $q2=$this->db->query("SELECT c.item_name, a.sales_qty,
                                  ...
                                  a.total_cost
                                  FROM 
                                  db_quoteitems AS a,db_tax AS b,db_items AS c 
                                  WHERE 
