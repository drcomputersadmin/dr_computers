        ...
        <div class="printableArea">
          ...
          <div class="row invoice-info">
            ...
            <style>
              ...
              .payment-status-label.bg-danger {
                background-color: #dc3545;
                /* Adjust the color as needed */
              }

              .payment-status-label.bg-success {
                background-color: #28a745;
                /* Adjust the color as needed */
              }

              .payment-status-label.bg-warning {
            ...
            <div class="col-sm-4 invoice-col">
              ...
              // Additional CSS class to adjust label length if needed
              // $payment_status_color = ($payment_status === 'Unpaid') ? 'red' : (($payment_status === 'paid') ? 'green' : 'orange');
              ?>
              <label class="payment-status-label <?php echo $payment_status_class; ?>"><?php echo $payment_status_text; ?></label><br>
