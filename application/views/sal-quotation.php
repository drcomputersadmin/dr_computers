  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><?= $this->lang->line('quotation'); ?></li>
      </ol>
    </section>
    <div class="row">
      <div class="col-md-12">
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-globe"></i> <?= $this->lang->line('sales_quotation'); ?>
      ...
      <div class="row invoice-info">
        ...
        <!-- /.col -->
        <div class="col-sm-4 invoice-col">
          <b><?= $this->lang->line('quotation'); ?> #<?php echo  $sales_code; ?></b><br>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <?php $str2= ($pos==1)? 'pos/edit/':'sales/update_quote/'; ?>
